...
<!-- Prompts to answer once done:
     - How long did pending→firing→resolved actually take, and does that match the `for:` I set?
     - Did anything in the chain surprise me / not work the first time?
     - Now that I've seen it fire, do I trust this stack to wake me for a real problem? -->
